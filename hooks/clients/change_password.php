...
add_hook("ClientChangePassword", 1, function($params) {

	$Template = Capsule::table("mod_zend_templates")->where([ ["hook", "ClientChangePassword"], ["type", "client"] ])->first();
	if ( $Template->is_active ):

        $Client = Capsule::table("tblclients")->find($params["userid"]);
